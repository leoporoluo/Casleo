...
describe('Harness launch contract', () => {
  ...
  it('disclaims macOS TCC responsibility when Harness runs as a utility process', () => {
    ...
    const nodeArguments = buildNodeArguments(
      '/Applications/Casleo.app/Contents/Resources/harness-node-entry.mjs',
      '/Applications/Casleo.app/Contents/Resources/app/node_modules/@deepseek-ai/dsh/lib/bin.js',
      43127,
      '/Applications/Casleo.app/Contents/Resources/dsh-desktop.patch.yml'
    )

    expect(buildDisclaimedUtilityProcessSpec(nodeArguments, spawnOptions)).toEqual({
      modulePath: '/Applications/Casleo.app/Contents/Resources/harness-node-entry.mjs',
      args: [
        '/Applications/Casleo.app/Contents/Resources/app/node_modules/@deepseek-ai/dsh/lib/bin.js',
        'web',
        '--patch',
