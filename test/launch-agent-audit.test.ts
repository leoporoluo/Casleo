...
const appBundle = '/Applications/Casleo.app'
const helper = `${appBundle}/Contents/Frameworks/Casleo Helper.app/Contents/MacOS/Casleo Helper`
...
describe('daemonised app binary detection', () => {
  ...
  it('does not treat a sibling bundle as our own', () => {
    const sibling = '/Applications/Casleo Dev.app/Contents/MacOS/Casleo Dev'
  ...
  it('does not treat a bundle whose name merely extends ours as our own', () => {
    const lookalike = '/Applications/Casleo.app.disabled/Contents/MacOS/Casleo'
...
describe('app bundle path', () => {
  it('finds the bundle root above the executable', () => {
    expect(appBundlePathFromExecutable('/Applications/Casleo.app/Contents/MacOS/Casleo'))
      .toBe('/Applications/Casleo.app')
  })
