...
const STRINGS = {
  en: {
    ...
    back: 'Back',
    fieldID: 'Provider ID',
    fieldIDHelp: 'Lowercase letters, digits, - and _. Used as provider/model.',
    fieldName: 'Display name',
    fieldProtocol: 'Protocol',
    fieldBaseURL: 'Base URL',
    fieldAPIKey: 'API key',
    fieldAPIKeyHelp: 'Written to opencode.json as settings.apiKey.',
    modelsTitle: 'Models',
    modelID: 'Model ID',
  ...
  zh: {
    ...
    back: '返回',
    fieldID: '供应商 ID',
    fieldIDHelp: '只能用小写字母、数字、- 和 _，会作为 供应商/模型 的前缀。',
    fieldName: '供应商名称',
    fieldProtocol: '协议',
    fieldBaseURL: 'Base URL',
    fieldAPIKey: 'API Key',
    fieldAPIKeyHelp: '会以 settings.apiKey 写进 opencode.json。',
    modelsTitle: '模型',
    modelID: '模型 ID',
    modelName: '显示名称',
    modelContext: '上下文长度',
    modelOutput: '最大输出',
    modelReasoning: '推理档位',
    modelReasoningHelp: '用逗号分隔，例如 low, medium, high',
    addModel: '添加模型',
    removeModel: '删除',
    save: '保存',
    saving: '保存中…',
