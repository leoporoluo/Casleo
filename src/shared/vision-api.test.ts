...
describe("restoring a stored handoff", () => {
  const stored = visionAgentPrompt("这是什么", ["/Users/me/Library/Application Support/Casleo/uploads/1786-1.png"]);

  it("recovers the staged upload paths and their preview urls", () => {
    expect(visionHandoffPaths(stored)).toEqual([
      "/Users/me/Library/Application Support/Casleo/uploads/1786-1.png",
    ]);
