...
const zh = {
  "update.title": "Casleo 更新",
  "update.latest": "已是最新版本",
  "update.currentVersion": "当前版本：v{version}",
  "update.available": "发现新版本 Casleo v{version}",
  ...
  "nav.maximize": "最大化或还原",
  "nav.closeWindow": "关闭",
  "nav.settingsTitle": "Casleo 设置",
  "menu.settings": "设置",
  "menu.language": "语言",
  "menu.langZh": "中文 (中国)",
  "menu.langEn": "English (United States)",
  "nav.modelUnset": "未配置模型",
  "nav.manageKeys": "Casleo 设置",
  "nav.configureKeys": "配置 Casleo",
  ...
  "settings.themePaper": "亮色",
  "settings.themeDark": "暗色",
  "settings.themeHint": "选择界面配色，立即生效。",
  "settings.themeSystemDesc": "自动匹配 Windows 外观",
  ...
  "settings.pluginsUse": "Extensions 由 Pi 从全局与当前项目的标准目录自动发现。点击条目可打开插件目录。",
  "settings.pluginsPaths": "标准存放路径",
  "settings.pluginsPathProject": "项目",
  "settings.pluginsPathUser": "用户全局",
  "settings.pluginsTitle": "已发现的插件",
  "settings.pluginsRefresh": "刷新列表",
  "settings.pluginsEmpty": "当前没有发现插件。将插件放入 Pi 标准目录后刷新。",
  "settings.pluginsRevealFailed": "无法打开插件目录",
  "settings.packages": "Packages",
  "settings.packagesUse": "Packages 按 Pi 官方规范通过全局或项目 settings.json 配置，可来自 npm、Git 仓库或本地路径。npm 与 Git 包由 Pi 管理安装位置。",
  "settings.packagesConfig": "Package 配置与资源路径",
  "settings.packagesPathUser": "用户全局",
  "settings.packagesPathProject": "项目（需信任）",
  "settings.packagesSources": "包中的 extensions、skills、prompts 和 themes 会由 Pi 自动发现；项目包仅在项目受信任后加载。",
  "settings.packagesOpen": "打开全局 Agent 文件夹",
  "settings.packagesInstalled": "已配置的 Packages",
  "settings.packagesEmpty": "当前 settings.json 没有配置 Package。",
  "settings.resourceDelete": "删除",
  "settings.resourceDeleteTitle": "删除这个资源？",
  "settings.resourceDeleteBody": "将删除“{name}”。此操作无法撤销。",
  ...
  "settings.apiTransport": "接口协议",
  "settings.advanced": "高级选项",
  "settings.maxTokens": "最大输出 Token（可选）",
  "settings.contextWindow": "上下文窗口 Token",
  "settings.profileEffort": "默认推理强度",
  "settings.closeToTray": "点击关闭时最小化到托盘",
  "settings.closeToTrayHint": "默认开启；从托盘菜单可以退出 Casleo。",
  "settings.startup": "开机自动启动",
  "settings.startupHint": "默认关闭，可随时在此开启。",
  "settings.toggleValue": "开关值",
  "settings.toggleOn": "开启",
  "settings.toggleOff": "关闭",
  "settings.maxTokensPlaceholder": "留空使用默认",
  "settings.maxTokensHint": "默认 32768；若网关有更低上限可继续调小。",
...
const en: Record<MessageKey, string> = {
  ...
  "nav.settingsTitle": "Casleo settings",
  "menu.settings": "Settings",
  "menu.language": "Language",
  "menu.langZh": "中文 (中国)",
  "menu.langEn": "English (United States)",
  "nav.modelUnset": "Model not configured",
  "nav.manageKeys": "Casleo settings",
  "nav.configureKeys": "Set up Casleo",
  ...
  "toast.needJobCommands":
    "Stopping background jobs needs an updated Pi runtime",
  ...
  "perm.ask": "Request approval",
  "perm.askDesc": "Always ask before editing files outside the workspace or using the internet.",
  "perm.auto": "Approve for me",
  "perm.autoDesc": "Ask only when a risky operation is detected.",
  "perm.full": "Full access",
  "perm.fullDesc":
    "Unrestricted internet and filesystem access on this computer.",
  ...
  "settings.themePaper": "Light",
  "settings.themeDark": "Dark",
  "settings.themeHint": "Pick a palette. It applies immediately.",
  "settings.themeSystemDesc": "Match the Windows appearance",
  ...
  "settings.plugins": "Extensions",
  "settings.pluginsUse": "Pi discovers extensions from its global and current project standard directories. Click an item to reveal its folder.",
  "settings.pluginsPaths": "Standard locations",
  "settings.pluginsPathProject": "Project",
  "settings.pluginsPathUser": "User-global",
  "settings.pluginsTitle": "Discovered plugins",
  "settings.pluginsRefresh": "Refresh",
  "settings.pluginsEmpty": "No extensions found. Add one to a Pi standard directory, then refresh.",
  "settings.pluginsRevealFailed": "Could not open the plugin directory",
  "settings.packages": "Packages",
  "settings.packagesUse": "Packages follow Pi's official settings.json configuration and can come from npm, Git repositories, or local paths. Pi manages npm and Git install locations.",
  "settings.packagesConfig": "Package configuration and resource paths",
  "settings.packagesPathUser": "User-global",
  "settings.packagesPathProject": "Project (trusted)",
  "settings.packagesSources": "Pi discovers extensions, skills, prompts, and themes inside each package. Project packages load only after the workspace is trusted.",
  "settings.packagesOpen": "Open global Agent folder",
  "settings.packagesInstalled": "Configured Packages",
  "settings.packagesEmpty": "No Packages are configured in settings.json.",
  "settings.resourceDelete": "Delete",
  "settings.resourceDeleteTitle": "Delete this resource?",
  "settings.resourceDeleteBody": "This will delete “{name}”. This action cannot be undone.",
  ...
  "settings.apiTransport": "API transport",
  "settings.advanced": "Advanced",
  "settings.maxTokens": "Max output tokens (optional)",
  "settings.contextWindow": "Context window tokens",
  "settings.profileEffort": "Default reasoning effort",
  "settings.closeToTray": "Minimize to tray when closing",
  "settings.closeToTrayHint": "Enabled by default; quit Casleo from the tray menu.",
  "settings.startup": "Launch at startup",
  "settings.startupHint": "Disabled by default; you can enable it here.",
  "settings.toggleValue": "Toggle value",
  "settings.toggleOn": "On",
  "settings.toggleOff": "Off",
  "settings.maxTokensPlaceholder": "Default if empty",
  "settings.maxTokensHint":
    "Defaults to 32768. Lower it only when your gateway has a smaller cap.",
