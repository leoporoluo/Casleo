...
const zh = {
  ...
  "settings.pluginsEmpty": "当前没有发现插件。将插件放入 Casleo 或项目插件目录后刷新。",
...
const en: Record<MessageKey, string> = {
  ...
  "settings.pluginsEmpty": "No plugins found. Add one to a Casleo or project plugin folder, then refresh.",
