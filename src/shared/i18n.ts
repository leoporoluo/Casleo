...
const zh = {
  ...
  "think.done": "思考过程",
  "activity.live": "Agent activity",
  "activity.summary": "Agent activity · {steps} 步 · {duration}",
  ...
  "settings.contextWindow": "上下文窗口 Token（可选）",
  "settings.modelDefault": "模型默认",
  ...
  "settings.maxTokensPlaceholder": "留空使用模型默认",
  "settings.maxTokensHint": "留空则使用当前模型上限，且不会超过上下文窗口。",
...
const en: Record<MessageKey, string> = {
  ...
  "think.done": "Thinking",
  "activity.live": "Agent activity",
  "activity.summary": "Agent activity · {steps} steps · {duration}",
  ...
  "settings.contextWindow": "Context window tokens (optional)",
  ...
  "settings.maxTokensPlaceholder": "Model default if empty",
  "settings.maxTokensHint": "Leave empty to use the current model's limit; never exceeds the context window.",
