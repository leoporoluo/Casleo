...
// Regenerate the startup splash loaders (build/casleo-loader.gif and
// build/casleo-loader-dark.gif) from the brand mark in build/brand-mark.svg.
...
const MARK_VIEWBOX = { x: 250, y: 219, width: 500, height: 578 }
/** Body width in cells; matches the ~310px silhouette of the previous loader. */
const BODY_CELLS = 78

const THEMES = {
  light: {
    file: 'casleo-loader.gif',
    body: [43, 43, 43],
    sparks: [[242, 237, 227], [214, 205, 188], [176, 166, 148]]
  },
  dark: {
    file: 'casleo-loader-dark.gif',
    body: [242, 237, 227],
    sparks: [[214, 205, 188], [200, 189, 170], [176, 166, 148]]
  }
}
